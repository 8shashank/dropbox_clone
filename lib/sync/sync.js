...
function getFilesToBeOverwritten(path1,path2,filesToWrite1,filesToWrite2,cb) {
    getDirectoryInfo(path1,function(directoryInfo1){
        getDirectoryInfo(path2,function(directoryInfo2){
            var fileList1 = directoryInfo1.fileList;
            fileList1 = _.intersection(filesToWrite1, fileList1);
            var fileList2 = directoryInfo2.fileList;
            fileList2 = _.intersection(filesToWrite2, fileList2)
            cb({
                overwriteFiles1:fileList1,
                overwriteFiles2:fileList2
            });
        });
    });
}
...
module.exports = {
    ...
    getFilesToBeOverwritten:getFilesToBeOverwritten
}
